...
// Increased slightly to keep walkable gaps with PLAYER_RADIUS=2
export const DISTRICT_ALLEY_CLEARANCE = 3;
...
// Smaller step -> more edge candidates -> denser ring near borders
export const DISTRICT_BORDER_STEP = 30;
// per-building area heuristic fallback when target coverage would place too few buildings
export const DISTRICT_AREA_PER_BUILDING = 60000;
// min/max buildings to try to place (safety clamps)
export const DISTRICT_MIN_BUILDINGS = 16;
